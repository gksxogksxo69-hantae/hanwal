    ...
    Alpine.data('tutorialApp', () => ({
        ...
        get scenes() {
            const allScenes = [
                ...
                { speaker: '지문', text: `그러나 운명은 가혹했다. ${this.playerGender === 'MALE' ? '형들' : '오라버니들'}이 떠난 지 정확히 1년이 되던 날, 천마의 최측근이자 잔혹한 살인귀인 '우호법(右護法)'이 남궁의 씨를 말리기 위해 밤안개를 뚫고 가문을 기습했다!`, effect: 'fire-effect-overlay' },
