...
(1, 1, 1, '혈겁의 시작', '스테이지 1-1 클리어', 1000, 100),
(2, 1, 2, '불타는 장저', '스테이지 1-2 클리어', 1200, 100),
(3, 1, 3, '가문의 생존자', '스테이지 1-3 클리어', 1500, 100),
(4, 1, 4, '포위망 돌파', '스테이지 1-4 클리어', 1800, 100),
(5, 1, 5, '협객의 등장', '스테이지 1-5 클리어', 2500, 1500),
(6, 1, 6, '천하객잔의 인연', '객잔에서 새로운 동료 영입하기', 3000, 100),
(7, 2, 6, '서행의 시작', '스테이지 2-1 클리어', 4000, 100),
(8, 2, 7, '강호의 냉혹함', '스테이지 2-2 클리어', 4500, 100);
